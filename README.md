...
- [JSON Schema](https://github.com/cds-snc/platform-forms-client/blob/develop/lib/middleware/schemas/templates.schema.json)
- [JSON Schema Documentation](https://github.com/cds-snc/platform-forms-client/blob/develop/documentation/Forms/FormViewer.md)
- The documentation is generated by executing the follow yarn command: `yarn generate-json-schema-docs`
- Generating the documentation requires [JSON Schema for Humans](https://github.com/coveooss/json-schema-for-humans), which can be installed by the following command: `pip install json-schema-for-humans`
...
- [Schéma JSON](https://github.com/cds-snc/platform-forms-client/blob/develop/lib/middleware/schemas/templates.schema.json)
- [Documentation du schéma JSON](https://github.com/cds-snc/platform-forms-client/blob/develop/documentation/Forms/FormViewer.md)
- La documentation est générée en exécutant la commande yarn suivante : `yarn generate-json-schema-docs`
- La génération de la documentation nécessite [JSON Schema for Humans](https://github.com/coveooss/json-schema-for-humans), qui peut être installé par la commande suivante : `pip install json-schema-for-humans`
