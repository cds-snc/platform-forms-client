...
export const PanelActions = ({
  ...
  const outerPanelClasses = isSubPanel
    ? ""
    : `z-[2] laptop:absolute laptop:invisible laptop:group-[.active]:visible laptop:group-active:visible laptop:group-focus-within:visible laptop:right-0 laptop:top-0 ${
