...
export const PublishCard = async ({
  ...
  sourceTemplateHasResponses: boolean;
  ...
  return (
    <div className="rounded-lg border-1 p-5">
      ...
      <Publish
        ...
        sourceTemplateHasUnprocessed={sourceTemplateHasResponses}
        workingCopyHasResponses={workingCopyHasResponses}
      />
    </div>
  );
};
