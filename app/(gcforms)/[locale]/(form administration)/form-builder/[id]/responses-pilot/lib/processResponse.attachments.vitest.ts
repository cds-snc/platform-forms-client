...
describe("processResponse - attachment handling", () => {
  ...
  describe("attachments with duplicate names", () => {
    ...
    it("creates mapping.json with renamed filenames for duplicates", async () => {
      ...
      expect(attachment1.isPotentiallyMalicious).toBe(false);
      ...
      expect(attachment2.isPotentiallyMalicious).toBe(false);
      ...
      expect(attachment3.isPotentiallyMalicious).toBe(false);
      ...
      expect(attachment4.isPotentiallyMalicious).toBe(false);
      ...
      expect(attachment5.isPotentiallyMalicious).toBe(false);
    });
