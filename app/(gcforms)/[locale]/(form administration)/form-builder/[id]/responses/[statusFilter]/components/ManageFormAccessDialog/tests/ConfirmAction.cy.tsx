...
describe("ConfirmAction Component", () => {
  it("renders correctly", () => {
    ...
    mount(<ConfirmAction callback={callback} />);
  ...
  it("displays confirmString and buttonLabel props", () => {
    const callback = cy.stub().resolves(true);
    mount(<ConfirmAction callback={callback} confirmString="Confirm?" buttonLabel="Delete" />);
  ...
  it("applies buttonTheme prop", () => {
    const callback = cy.stub().resolves(true);
    mount(<ConfirmAction callback={callback} buttonTheme="primary" />);
