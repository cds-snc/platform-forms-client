...
export const StartAgain = ({ formId }: { formId: string }) => {
  ...
  return (
    <button
      className="group flex items-center rounded-full border-1 border-slate-500 bg-gray-background p-2 px-6 hover:cursor-pointer hover:border-indigo-700 hover:bg-violet-50 focus:cursor-pointer focus:border-gcds-blue-vivid focus:bg-gcds-blue-vivid focus:text-white-default focus:outline focus:outline-[3px] focus:outline-offset-2 focus:outline-gcds-blue-vivid tablet:px-14"
      onClick={async (e) => {
        e.preventDefault();
