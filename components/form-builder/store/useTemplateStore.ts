...
export const defaultForm = {
  ...
  introduction: {
    descriptionEn: "Add an introduction",
    descriptionFr: "Add an introduction (FR)",
  },
  privacyPolicy: {
    descriptionEn: "Email addresses will not be shared.",
    descriptionFr: "Email addresses will not be shared. (FR)",
  },
  elements: [],
  emailSubjectEn: "",
  emailSubjectFr: "",
