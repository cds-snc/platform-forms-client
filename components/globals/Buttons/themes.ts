export const themes = {
  base: "py-2 px-5 border-2 border-solid inline-flex items-center active:top-0.5 focus:outline-[3px] focus:outline-blue-focus focus:outline focus:outline-offset-2 focus:bg-blue-focus focus:border-blue-active focus:text-white-default active:text-white-default active:bg-blue-active active:outline-[3px] active:outline-blue-focus active:outline-offset-2 active:bg-blue-focus disabled:cursor-not-allowed disabled:text-gray-dark disabled:bg-gray-light disabled:!border-none",
