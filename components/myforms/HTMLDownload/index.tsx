...
import { SkipLink } from "@components/globals";
...
// Safari. In Safari simple cases work but complex ones often fail. It looks like Safari's
// implementation of execCommand() is not consistent and no suprise since no official spec
// exists in HTML5 and most browsers mark it as deprecated but no API has replaced it yet...

// Note: dangerouslySetInnerHTML will replace any `\'` with `'` and cause a syntaxe error. Must
// manually remove or change th `\'` for ClipboardJS minified.
