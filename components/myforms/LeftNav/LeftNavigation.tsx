...
export const LeftNavigation = () => {
  ...
  const iconClassname =
    "inline-block mr-1 inline-block h-6 xl:block xl:mx-auto group-hover:fill-blue-hover group-focus:fill-white-default group-active:fill-white-default mr-2 mt-1";
