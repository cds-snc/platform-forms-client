describe(
  "TSB Contact Form functionality",
  ...
  () => {
    ...
    it("Fill out the form", () => {
      ...
      cy.get("textarea[id='6']")
        .type(
          "Contacting the Transportion Safety Board for a personal inquiry"
        )
        .should(
          "have.value",
          "Contacting the Transportion Safety Board for a personal inquiry"
    ...
    it("Submit the Form", () => {
      ...
      cy.url().should(
        "include",
        `/en/id/${formMetaData.form.id}/confirmation`
      );
      cy.get("h1").contains("Thank you for your message");
      cy.get("[data-testid='fip']")
        .find("img")
        .should("have.attr", "src", "/img/tsb-en.png");
