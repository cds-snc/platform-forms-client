...
An option to add rich text to the form, either in markdown or HTML
...
```json
{
  ...
  "properties": {
    ...
    "placeholderEn": "",
    "placeholderFr": "",
    "descriptionEn": "<h2 class=\"gc-h2 gc-section-header\">Organization Primary Address</h2> \n Follow up text, below the heading. <ol><li>A list item</li></ol>",
    "descriptionFr": "<h2 class=\"gc-h2 gc-section-header\">Adresse principale de l’organismen</h2>",
    "charLimit": 5000,
    "validation": {
      "required": false
    }
...
Every field has a key `validation` that can contain the following values:
