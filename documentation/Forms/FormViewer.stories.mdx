...
1. Form object in the context of Form Viewer
   ...
   `securityAttribute`: It shows an administrator what proceduce should be taken when accessing a form's responses, possible value Protected B, Protected A, Unclassified
