...
This is an effort to identify the UI inventory used by CDS Platform Forms and showcase it in Storybook.
...
In addition to having an overview of the Forms Design System, the inventory will show:
