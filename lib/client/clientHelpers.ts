 ...
 * management to set a page load entry point using a DOM focus for an AT user. A form control
 * is preferred over a fallback selector like a heading, if one exists to avoid confusion e.g. #4690
 *
