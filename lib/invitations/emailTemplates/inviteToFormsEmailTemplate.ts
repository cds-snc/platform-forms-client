...
Once you [create an account](${registerUrlEn}), you can join your colleague's form to make changes to it or to help manage form responses. 
...
Une fois que vous [créez un compte](${registerUrlFr}) vous pouvez rejoindre le formulaire de votre collègue afin d'y faire des modifications ou pour aider à gérer les réponses au formulaire. 
