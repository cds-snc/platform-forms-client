...
// Note: this feature is not currently being used may in the future. This code will need more work
// to handle "dynamic rows".
// Note: this depends on clipboardjs in ../html/scripts.js
export const copyResponsesFromTableToClipboardScript = function (lang = "en") {
  const { t } = customTranslate("my-forms");
