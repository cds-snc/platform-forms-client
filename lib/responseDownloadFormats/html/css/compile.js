...
const tailwindResult = shell.exec(
  "npx tailwindcss@3.4.1 -c ./tailwind.config.js -i ./css/temp.css -o ./css/output.css --minify --no-source-map",
  { silent: true }
);
...
let cssContent = fs.readFileSync("./css/output.css", "utf8");
// Escape backslashes for JS string literal
cssContent = cssContent.replace(/\\/g, "\\\\");
const css = "export const css = `" + cssContent + "`;";
