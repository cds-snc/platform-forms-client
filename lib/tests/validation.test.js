...
describe("Gov Email domain validator", () => {
  ...
  it("Should return false with an empty string passed as email", async () => {
    expect(isValidGovEmail(null, "{}")).toBeFalsy();
  });

  it("Should return false with an empty string passed as email", async () => {
    expect(isValidGovEmail(undefined, "{}")).toBeFalsy();
  });
  ...
  it("Should return true : specific test TBS", async () => {
    expect(isValidGovEmail("test@tbs-sct.gc.ca", emailDomains.domains)).toBeTruthy();
  });

  it("Should return true : specific test SSC", async () => {
    expect(isValidGovEmail("test@ssc-spc.gc.ca", emailDomains.domains)).toBeTruthy();
  });

  it("Should return true : anything ending in gc.ca", async () => {
    expect(isValidGovEmail("test@AAAAAA.BBBBBB.gc.ca", emailDomains.domains)).toBeTruthy();
  });

  it("Should return false : public email test 1", async () => {
    expect(isValidGovEmail("test@hotmail.com", emailDomains.domains)).toBeFalsy();
  });

  it("Should return false : public email test 2", async () => {
    expect(isValidGovEmail("test@gmail.com", emailDomains.domains)).toBeFalsy();
  });

  it("Should return false : public email test 3", async () => {
    expect(isValidGovEmail("test@outlook.com", emailDomains.domains)).toBeFalsy();
  });
});
