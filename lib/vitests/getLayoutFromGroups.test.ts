...
describe("getLayoutFromGroups function", () => {
  ...
  it("Handles groups with elements", () => {
    const groups = {
      "group1": { name: "group1", titleEn: "", titleFr: "", nextAction: "group2", elements: ["5", "8", "10"] }
    };
  ...
  it("Handles multiple groups with element", () => {
    const groups = {
      ...
      "group1": { name: "group1", titleEn: "", titleFr: "", nextAction: "group2", elements: ["5", "8", "10"] },
      "group2": { name: "group2", titleEn: "", titleFr: "", nextAction: "group3", elements: ["21", "24"] },
  ...
  it("Handles multiple groups with some elements", () => {
    const groups = {
      ...
      "group1": { name: "group1", titleEn: "", titleFr: "", nextAction: "group2", elements: ["18", "2"] },
