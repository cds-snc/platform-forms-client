...
/**
 * Wraps builder description examples in a styled "Try it" fieldset with a
 * Formik context, matching the form filler environment.
 */
export const ExampleWrapper = ({
  ...
  return (
    <fieldset
      className={cn("relative mt-4! rounded-lg border border-slate-400 bg-white p-4!", className)}
    >
