...
sw.addEventListener("fetch", function (event) {
  ...
  if (
    ((_a = request.headers.get("Accept")) === null || _a === void 0
      ? void 0
      : _a.indexOf("text/html")) !== -1 &&
  ...
  if (
    ((_b = request.headers.get("Accept")) === null || _b === void 0
      ? void 0
      : _b.indexOf("text/plain")) === -1 &&
    request.url.startsWith(this.origin)
  ) {
    event.respondWith(
      caches.match(request).then(function (response) {
        return (
          ...
          fetch(request).then(function (response) {
            ...
            var copy = response.clone();
            if (
              ((_a = copy.headers.get("Content-Type")) === null || _a === void 0
                ? void 0
                : _a.indexOf("text/plain")) === -1
            ) {
              caches.open(version + cacheName).then(function (cache) {
                cache.put(request, copy);
              });
