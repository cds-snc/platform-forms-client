...
If you lose this key, or if it becomes compromised, you will have to generate a new API key for your form in Settings.

## For developers setting up a custom API integration
...
Si vous perdez cette clé ou si elle est compromise, vous devrez en générer une nouvelle dans les Paramètres du formulaire.

## Pour les développeurs·se·s qui configurent une intégration sur mesure
