...
- Implementing a basic file scanning feature to help detect and alert clients to potentially malicious files attached to form submissions by end-users. CDS does not provide additional support for malicious files beyond this. As outlined in the [Terms of use](https://forms-formulaires.alpha.canada.ca/en/terms-of-use), clients are responsible for deciding how to use this information.
