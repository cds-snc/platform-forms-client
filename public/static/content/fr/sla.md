...
- de mettre en place d'une fonctionnalité d'analyse de base pour aider à détecter les fichiers potentiellement malveillants joints aux soumissions de formulaires par les utilisateurs finaux et d'alerter les clients à ce sujet. Le SNC n'offre aucune assistance supplémentaire concernant les fichiers malveillants au-delà de cette fonctionnalité. Comme indiqué dans les [Conditions d'utilisation](https://forms-formulaires.alpha.canada.ca/fr/terms-of-use), il incombe aux clients de décider de l'usage qu'ils souhaitent faire de ces informations.
