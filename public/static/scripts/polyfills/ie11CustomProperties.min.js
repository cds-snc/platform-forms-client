...
!(function () {
    ...
    document.addEventListener("mousedown", function (e) {
      setTimeout(function () {
        if (e.target === document.activeElement) {
          ...
          t.initEvent("CSSActivate", !0, !0),
            (y = e.target).dispatchEvent(t);
        }
      });
    }),
  ...
  function A(e, t) {
    ...
    for (
      ...
      e.elements.has(r) ||
        (e.elements.set(r, !0), e.callback.call(r, r));
  }
  function V(e) {
  ...
  function X(e) {
    e.ieCP_unique ||
      ((e.ieCP_unique = ++v),
      e.classList.add("iecp-u" + e.ieCP_unique));
