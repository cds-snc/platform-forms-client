...
!(function () {
  ...
  if (
    ...
    g.getPropertyValue = function (e) {
      if (((this.lastPropertyServedBy = !1), "-" !== (e = e.trim())[0] || "-" !== e[1]))
  ...
  function M(e, o) {
    for (
      var i, s = { selector: e, callback: o, elements: new WeakMap() }, c = w(n, s.selector), l = 0;
      (i = c[l++]);
  ...
  function N(e, t, r) {
    ...
    const s = r.split(",");
    for (
      e.setAttribute("iecp-needed", !0), e.ieCPSelectors || (e.ieCPSelectors = {});
      (n = t[i++]);
      ...
      for (o = 0; (r = s[o++]); ) {
        ...
        e.ieCPSelectors[n] || (e.ieCPSelectors[n] = []),
          e.ieCPSelectors[n].push({ selector: t[0], pseudo: t[1] ? "::" + t[1] : "" });
      }
  }
  function z(e, t) {
    I(e),
        ...
        for (var c, l = 0; (c = e.ieCPSelectors[n][l++]); )
          "%styleAttr" === c.selector && (e.style[n] = s),
            (o || !1 === i.allByRoot) &&
              (c.pseudo
                ? (r +=
                    c.selector + ".iecp-u" + e.ieCP_unique + c.pseudo + "{" + n + ":" + s + "}\n")
                : (e.runtimeStyle[n] = s));
      }
    }
    !(function (e, t) {
  ...
  function Q(e, t, r) {
    return (function (e, t) {
      ...
      return (
        o && (i = i.replace(/^calc\(/, "(")),
        r && e.lastPropertyServedBy !== document.documentElement && (r.allByRoot = !1),
        "" === i && n && (i = Q(e, n, r)),
        i
      );
    });
