...
async function deleteFileAttachmentsFromS3(fileAttachments: string[]): Promise<void> {
...
async function deleteResponsesFromDynamodb(responses: FormResponse[]): Promise<void> {
